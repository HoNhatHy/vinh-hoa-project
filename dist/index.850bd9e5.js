...
})({"3IgjF":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const createMarkup = function(acc) {
    const imgName = convertText(acc.name);
    const markup = `
  <li class="customer">
    <img
      class="customer-img"
      src="img/accounts/${imgName.join("-")}.jpg"
...
document.querySelector(".search-btn").addEventListener("click", function(e) {
    ...
    accounts.forEach((acc)=>{
        if (convertText(acc.name).includes(convertText(inputValue))) document.querySelector(".customers-infor").insertAdjacentHTML("afterbegin", createMarkup(acc));
    });
});

},{}]},["3IgjF","1GgH0"], "1GgH0", "parcelRequiree15d")
